...
struct CameraEvent: Identifiable, Equatable {
    ...
    var typeSymbol: String {
        switch type {
        case "een.motionDetectionEvent.v1":             return "eye"
        case "een.motionInRegionDetectionEvent.v1":     return "scope"
        case "een.personDetectionEvent.v1":             return "person"
        case "een.personMotionDetectionEvent.v1":       return "figure.walk"
        case "een.animalDetectionEvent.v1":             return "pawprint"
        case "een.faceDetectionEvent.v1":               return "face.smiling"
        case "een.vehicleDetectionEvent.v1":            return "car"
        case "een.vehicleMotionDetectionEvent.v1":      return "car.fill"
        case "een.gunDetectionEvent.v1":                return "exclamationmark.shield"
        case "een.weaponDetectionEvent.v1":             return "exclamationmark.shield"
        case "een.fallDetectionEvent.v1":               return "figure.fall"
        case "een.fireDetectionEvent.v1":               return "flame"
        case "een.spillDetectionEvent.v1":              return "drop"
        case "een.crowdFormationDetectionEvent.v1":     return "person.3"
        case "een.tamperDetectionEvent.v1":             return "exclamationmark.triangle"
        case "een.loiterDetectionEvent.v1":             return "clock"
        case "een.objectLineCrossEvent.v1":             return "arrow.right"
        case "een.objectLineCrossCountEvent.v1":        return "number"
        case "een.countedObjectLineCrossEvent.v1":      return "number"
        case "een.objectIntrusionEvent.v1":             return "xmark.shield"
        case "een.objectRemovalEvent.v1":               return "shippingbox"
        case "een.personTailgateEvent.v1":              return "door.left.hand.open"
        case "een.ppeViolationEvent.v1":                return "exclamationmark.triangle"
        case "een.sceneLabelEvent.v1":                  return "tag"
        case "een.eevaQueryEvent.v1":                   return "cpu"
        case "een.lprPlateReadEvent.v1":                return "rectangle.and.text.magnifyingglass"
        case "een.fleetCodeRecognitionEvent.v1":        return "truck.box"
        case "een.gunShotAudioDetectionEvent.v1":       return "waveform"
        case "een.t3AlarmAudioDetectionEvent.v1":       return "bell"
        case "een.t4AlarmAudioDetectionEvent.v1":       return "bell"
        case "een.posTransactionEvent.v1":              return "creditcard"
        case "een.deviceCloudStatusUpdateEvent.v1":     return "cloud"
        case "een.deviceCloudConnectionStatusUpdateEvent.v1": return "bolt.horizontal"
        case "een.edgeReportedDeviceStatusEvent.v1":    return "antenna.radiowaves.left.and.right"
        case "een.deviceIOEvent.v1":                    return "bolt"
        case "een.deviceOperationEvent.v1":             return "wrench"
        case "een.ptzPositionUpdateEvent.v1":           return "video"
        case "een.doorStatusEvent.v1":                  return "door.left.hand.open"
        case "een.batteryLevelUpdateEvent.v1":          return "battery.50"
        case "een.measurementThresholdStatusEvent.v1":  return "chart.bar"
        case "een.thermalCameraThresholdStatusEvent.v1": return "thermometer"
        case "een.panicButtonEvent.v1":                 return "sos"
        case "een.lockdownProtocolEvent.v1":            return "lock"
        case "een.secureProtocolEvent.v1":              return "shield"
        case "een.violenceDetectionEvent.v1":           return "exclamationmark.triangle"
        case "een.fightDetectionEvent.v1":              return "exclamationmark.triangle"
        case "een.vapeDetectionEvent.v1":               return "smoke"
